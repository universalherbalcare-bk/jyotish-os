...
namespace VedAstro.Library
{
	...
	public static partial class Calculate
	{
        ...
        /// </summary>
        public static Constellation Constellation(Time time, PlanetName planet)
        {
        ...
        public static LunarMonth LunarMonth(Time time)
        {
            ...
            {
                case ConstellationName.Aswini:
                    return Library.LunarMonth.Aaswayuja;
                    break;
                case ConstellationName.Bharani:
                    break;
                case ConstellationName.Krithika:
                    return Library.LunarMonth.Kaarteeka;
                    break;
                case ConstellationName.Rohini:
                    break;
                case ConstellationName.Mrigasira:
                case ConstellationName.Aridra:
                    return Library.LunarMonth.Maargasira;
                    break;
                case ConstellationName.Punarvasu:
                    break;
                case ConstellationName.Pushyami:
                    return Library.LunarMonth.Pushya;
                    break;
                case ConstellationName.Aslesha:
                    break;
                case ConstellationName.Makha:
                    return Library.LunarMonth.Maagha;
                    break;
                case ConstellationName.Pubba:
                    return Library.LunarMonth.Phaalguna;
                    break;
                case ConstellationName.Uttara:
                    break;
                case ConstellationName.Hasta:
                    break;
                case ConstellationName.Chitta:
                    return Library.LunarMonth.Chaitra;
                    break;
                case ConstellationName.Swathi:
                    break;
                case ConstellationName.Vishhaka:
                    return Library.LunarMonth.Vaisaakha;
                    break;
                case ConstellationName.Anuradha:
                    break;
                case ConstellationName.Jyesta:
                    return Library.LunarMonth.Jyeshtha;
                    break;
                case ConstellationName.Moola:
                    break;
                case ConstellationName.Poorvashada:
                    return Library.LunarMonth.Aashaadha;
                    break;
                case ConstellationName.Uttarashada:
                    break;
                case ConstellationName.Sravana:
                    return Library.LunarMonth.Sraavana;
                    break;
                case ConstellationName.Dhanishta:
                    break;
                case ConstellationName.Satabhisha:
                    break;
                case ConstellationName.Poorvabhadra:
                    return Library.LunarMonth.Bhaadrapada;
                case ConstellationName.Uttarabhadra:
                    break;
                case ConstellationName.Revathi:
                    break;
            ...
            //{
            //    case ConstellationName.Aswini:
            //        return LunarMonth.Aaswayuja;
            //        break;
            //    case ConstellationName.Krithika:
            //        return LunarMonth.Kaarteeka;
            //        break;
            //    case ConstellationName.Mrigasira:
            //        return LunarMonth.Maargasira;
            //        break;
            //    case ConstellationName.Pushyami:
            //        return LunarMonth.Pushya;
            //        break;
            //    case ConstellationName.Makha:
            //        return LunarMonth.Maagha;
            //        break;
            //    case ConstellationName.Pubba:
            //        return LunarMonth.Phaalguna;
            //        break;
            //    case ConstellationName.Chitta:
            //        return LunarMonth.Chaitra;
            //        break;
            //    case ConstellationName.Vishhaka:
            //        return LunarMonth.Vaisaakha;
            //        break;
            //    case ConstellationName.Jyesta:
            //        return LunarMonth.Jyeshtha;
            //        break;
            //    case ConstellationName.Poorvashada:
            //        return LunarMonth.Aashaadha;
            //        break;
            //    case ConstellationName.Sravana:
            //        return LunarMonth.Sraavana;
            //        break;
            //    case ConstellationName.Poorvabhadra:
            //        return LunarMonth.Bhaadrapada;
            //        break;
            //    default:
        ...
        public static Dasas CurrentPlanetDasas(Time birthTime, Time currentTime)
        {
            ...
            //    ? GetConstellation(birthTime, AstronomicalCalculator.GetLordOfHouse(HouseName.House1, birthTime)) 
            //    : GetMoonConstellation(birthTime);

            //get dasa planet at birth
            var moonConstellation = Constellation(birthTime, Library.PlanetName.Moon);
        ...
        public static HouseName[] AllHousesOrderedByStrength(Time time)
        {
            ...
            //CACHE MECHANISM
            return CacheManager.GetCache(new CacheKey("AllHousesOrderedByStrength", time), _getAllHousesOrderedByStrength);
