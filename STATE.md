...
Next: verifier final assessment running. Owner actions to reach PRODUCTION-READY: (1) ironclaw config set anthropic.api_key + models set-provider anthropic --model claude-sonnet-5 + launchctl kickstart; (2) scripts/github-bootstrap.sh --confirm.
